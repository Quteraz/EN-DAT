...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\LARGE Høgskolen i Vestfold}\\[1.5cm] % Main heading such as the name of your university/college
	...
	{\huge\bfseries TensorFlow og en rar tittel}\\[0.4cm] % Title of your document
